          ...
          <div className="mt-8  sm:mt-0 sm:w-full sm:px-8 flex flex-col justify-between text-center">
            <div className="flex flex-col sm:flex  sm:justify-between">
              <div className="my-2">
                <a
                  href="#"
                  className="text-gray-400  text-md hover:text-gray-50"
                >
                  İletişim
                </a>
              </div>
            ...
            <div className="  flex flex-row justify-evenly  ">
              ...
              <div className="my-2">
                <a href="#" className="text-white  text-md hover:bg-green-800">
                  <svg className="svg-icon" viewBox="0 0 20 20">
                    <path
                      fill="none"
              ...
              <div className="  my-2   ">
                <button
                  href="#"
                  className="mx-4 -my-2 px-4 md:px-5 font-bold text-gray-50 rounded-xl bg-gray-800 py-4   hover:bg-blue-500 transition duration-500 ease-in-out text-md "
                >
                  444 6 555
                </button>
              </div>
            ...
            <div className="text-gray-400  text-xs mb-10 mt-5">
              Ürünlerimiz gluten, balık, süt ürünleri ve susam ürünleri bulaşma
              riski olan alanda üretilmiştir.
            </div>
          </div>
        </div>
      </div>
